export default function Home() {
  const services = [
    ...
    {
      title: "Amiante",
      description: "Repérage des matériaux contenant de l'amiante dans votre bien",
      icon: "🔍",
      link: "/amiante"
    },
    {
      title: "Électricité",
      description: "Vérification complète de l'installation électrique",
      icon: "⚡",
      link: "/electricite"
    },
    {
      ...
      <header className="bg-white shadow-md sticky top-0 z-50">
        <nav className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            <div className="text-2xl font-bold text-blue-600">DIAG IMMO CAEN</div>
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              <div className="text-center mb-8">
                <p className="text-xl font-semibold text-gray-900">Fredy Meslin</p>
                <p className="text-gray-600 mb-4">
                  Expert en diagnostics immobiliers à Caen
                </p>
              ...
              <div className="border-t pt-8 mt-8">
                <p className="text-center text-gray-600">
                  Interventions à Caen et dans tout le Calvados
                </p>
              </div>
            </div>
          </div>
